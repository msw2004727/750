...
def process_ai_response(raw_text):
    # ... 省略 process_ai_response 函數的完整程式碼 ...
...
def register():
    ...
    try:
        ...
        if users_ref.where('nickname', '==', nickname).get():
        ...
        initial_world_state = {
            ...
            "pc_data": {
                ...
                "reputation_and_alignment": {
                    "morality_alignment": {"value": initial_morality, "level": "初始"},
                    # ... 其他聲望 ...
                },
                # ...
            },
            "world": {
                "player_current_location_name": "無名小村 - 村口",
                "in_game_time": "第一天 辰時",
                # ...
            },
